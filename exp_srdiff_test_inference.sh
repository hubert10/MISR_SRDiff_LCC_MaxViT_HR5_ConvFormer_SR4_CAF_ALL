...
srun python trainer.py --config configs/diffsr_highresnet_ltae.yaml --config_file flair-config-server.yml --exp_name misr/srdiff_highresnet_ltae_ckpt --hparams="cond_net_ckpt=/bigwork/nhgnkany/Results/MISR_SRDiff_LCC_MaxViT_HR5_ConvFormer_SR4_CAF_ALL/results/checkpoints/misr/srdiff_highresnet_ltae_ckpt" --infer
